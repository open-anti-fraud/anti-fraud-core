...
var ModuleFactory = (() => {
	...
	return function (ModuleFactory = {}) {
		...
		function _emscripten_webgl_get_context_attributes(c, a) {
			...
			var power =
				t['powerPreference'] &&
				emscripten_webgl_power_preferences.indexOf(
					t['powerPreference']
				);
			HEAP32[(a + 24) >> 2] = power;
		...
		var _addFloatToInputStream = (Module['_addFloatToInputStream'] =
			function () {
				return (_addFloatToInputStream = Module[
		...
		var _addBoolToInputStream = (Module['_addBoolToInputStream'] =
			function () {
				return (_addBoolToInputStream = Module[
		...
		var _addProtoToInputStream = (Module['_addProtoToInputStream'] =
			function () {
				return (_addProtoToInputStream = Module[
		...
		var _attachDoubleListener = (Module['_attachDoubleListener'] =
			function () {
				return (_attachDoubleListener = Module[
		...
		var _attachStringListener = (Module['_attachStringListener'] =
			function () {
				return (_attachStringListener = Module[
