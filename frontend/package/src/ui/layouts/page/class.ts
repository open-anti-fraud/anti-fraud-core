...
export default class PageLayout {
    ...
    private _createFooterElement() {
        ...
        element.classList.add('tdvc-base-content__footer');
        return element;
    }
